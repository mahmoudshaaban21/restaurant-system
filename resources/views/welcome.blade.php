                            ...
                            <ul id="menu-pricing" class="menu-price">
                                ...
                                @foreach($items as $key=>$item)
                                    <li class="item" id="{{$item->category->slug}}">
                                        <a href="#">
                                            <img style="height: 200px;width: 369px" src="{{asset('uploads/item/'.$item->image)}}" class="img-responsive img-thumbnail" alt="item" >
            ...
            <div class="container">
                        ...
                        <div class="info-test">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="copyright text-center">
                                    <p>
                                        &copy; Copyright, 2018 <a href="#">Mat3am</a> Developed by <a href=""  target="_blank">Mahmoud Shaaban</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="social-media">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <li><a target="_blank" href="#"><span class="footer-social-fb"><i class="fa fa-facebook"></i></span></a></li>
                            <li><a target="_blank" href="#"><span class="footer-social-plus"><i class="fa fa-google-plus"></i></span></a></li>
                            <li><a target="_blank" href="#"><span class="footer-social-twit"><i class="fa fa-twitter"></i></span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
